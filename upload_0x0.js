/**
 * upload_0x0.js
 * Uploads the release APK to 0x0.st (free permanent file host)
...
const BOUNDARY = 'FormBoundaryPOSMashinaniAPK';
...
const header = Buffer.from(
  '--' + BOUNDARY + '\r\n' +
  'Content-Disposition: form-data; name="file"; filename="pos-mashinani.apk"\r\n' +
  'Content-Type: application/vnd.android.package-archive\r\n\r\n'
);
const footer = Buffer.from('\r\n--' + BOUNDARY + '--\r\n');
const body = Buffer.concat([header, apkBuffer, footer]);

console.log('Uploading ' + (apkBuffer.length / 1024 / 1024).toFixed(1) + ' MB to 0x0.st...');
